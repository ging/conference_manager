...
public class StartConferenceResource extends ServerResource {

	protected static Logger log = LoggerFactory
		.getLogger(StartConferenceResource.class);
	...
	public void startConference() {
		log.debug("Starting conference " + conference.getId() + " manually");
